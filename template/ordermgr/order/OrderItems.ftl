                    ...
                    <#list orderItemList as orderItem>
                        ...
                        <#if orderItemShipGrpInvResList?exists && orderItemShipGrpInvResList?has_content>
                            <#list orderItemShipGrpInvResList as orderItemShipGrpInvRes>
                                ...
                                <#assign inventoryItemId = orderItemShipGrpInvRes.inventoryItemId />
                                <#assign invItem = delegator.findOne("InventoryItem", Static["org.ofbiz.base.util.UtilMisc"].toMap("inventoryItemId", inventoryItemId), false) />
                                <#assign invFacilityId = invItem.facilityId?if_exists />
                                <#assign facility = delegator.findOne("Facility", Static["org.ofbiz.base.util.UtilMisc"].toMap("facilityId", invFacilityId), false) />
                                
                                <#assign facilityName = facility.facilityName?if_exists />
                                <#if !facilityName?? >
                                    <#assign facilityName = facility.description?if_exists />
                                </#if>
                                ...
                                <tr<#if itemClass == "1"> class="alternate-row"</#if>>
                                    <td align="right" colspan="2">
                                        ...
                                        <span>${facilityName?default(invFacilityId)}</span>&nbsp;
                                ...
                                <tr<#if itemClass == "1"> class="alternate-row"</#if>>
                                    <td align="right" colspan="2">
                                        <#if itemIssuance.inventoryItemId?has_content>
                                            ...
                                            <#--@giulio -->
                                            <#assign invFacilityId = inventoryItem.facilityId?if_exists />
                                            <#assign facility = delegator.findOne("Facility", Static["org.ofbiz.base.util.UtilMisc"].toMap("facilityId", invFacilityId), false) />
