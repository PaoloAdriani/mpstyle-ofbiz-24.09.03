/*
 * MpStyle s.r.l. 2020
 * MpStyle custom log utility class.
 */
package mpstyle.log;
 ...
 * @author equake58
 */
public class MpStyleLogger {
    
    public static String module = MpStyleLogger.class.getName();
    
    private final static String MP_COOMPONENT = "mpstyle";
    private final static String LOGDIR = "LOG";
    private final static String LOG_FILE_PREFIX = "MM_";
    ...
    //constructor
    public MpStyleLogger(String tenantId, String logBaseFileName) {
    ...
    public MpStyleLogger(String tenantId, String logBaseFileName, String logDirectoryPath) {
  ...
  /** Method that checks if a file or directory does not exists.
    * @param dirpath the abstract pathname of the directory to checks
